 ...
 * @since  1.0.0
 */
class BookeventModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_BOOK_EVENT';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_book_event.bookevent';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_book_event.edit.bookevent.data', array());
	...
	/**
	 * Method to duplicate an Bookevent
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_book_event'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__book_event_');
				$max             = $db->loadResult();
