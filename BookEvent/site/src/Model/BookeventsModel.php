...
/**
 * Methods supporting a list of Book_event records.
 *
 * @since  1.0.0
 */
class BookeventsModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getApplication()->getIdentity()->authorise('core.edit', 'com_book_event'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_BOOK_EVENT_SEARCH_FILTER_DATE_FORMAT"), "warning");
